...
export class Check {
    ...
    is(val1, val2) {
        let pro1 = val1.prototype ? val1.prototype : val1;
        let pro2 = val2.prototype ? val2.prototype : val2;

        return util.getType(pro1) === util.getType(pro2);
    }
    ...
    */
    isArray(value) {
        return this.isType(value, util.types.array);
